...
?>   
    ...
    <div class="container-fluid">
      ...
      <div class="container-fluid">
        <h5 class="px-1 mt-1 py-3">Reminders Dashboard</h5>

        <div class="text-end py-2">
          <a href="<?php echo Config::SITEURL; ?>UnionAdminpanles/additions/addReminders.php">
    ...
    <script>
        ...
        function editRecord(newsId) {
            ...
            window.location.href = '<?php echo Config::SITEURL?>UnionAdminpanles/edit/editReminders.php?id=' + newsId;
        }
